...
// ==========================================
// OPCIÓN 1: RUTAS MATEMÁTICAS PARAMÉTRICAS
// ==========================================
...
// ==========================================
// OPCIÓN 2: RUTAS POR EXTRACCIÓN (WAYPOINTS)
// ==========================================
...
// ==========================================
// INSTRUCCIONES PRINCIPALES DEL TIMELINE
// ==========================================
...
[Serializable]
public struct TimeDataStruct
{
    public float time;
    public SpawnInstruction[] spawns;
}

[CreateAssetMenu(fileName = "TimeData", menuName = "Scriptable Objects/TimeData", order = 0)]
public class GameplayLevelTimeData : ScriptableObject
{
    [SerializeField] private AudioClip audioSource;
    [SerializeField] private TimeDataStruct[] timedata;

    public TimeDataStruct[] TimeData => timedata;
}

public abstract class TimeDataReader
{
